...
urlpatterns = [
    path(
        ...
        include(
            [
                path("v1/", include("mentorpunten.api.v1.urls", namespace="v1")),
            ]
        ),
    ),  # noqa
    path(
        ...
        TemplateView.as_view(
            template_name="mentorpunten/swagger.html",
    ...
    path(
        ...
        TemplateView.as_view(template_name="mentorpunten/swagger-oauth2-redirect.html"),
