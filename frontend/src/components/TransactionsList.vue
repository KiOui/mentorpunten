...
<template>
  ...
  <div v-else-if="!transactionsLoading && nextDataExists" class="w-100 d-flex justify-content-center">
    <button v-on:click="addNewData" class="btn btn-primary text-center">Load more</button>
  </div>
  <div v-else-if="!transactionsLoading && !nextDataExists" class="alert alert-info text-center">
