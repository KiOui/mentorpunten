...
import SubmissionAcceptCard from "@/components/SubmissionAcceptCard.vue";
...
<template>
  ...
  <SubmissionAcceptCard v-else v-for="submission in submissions" v-bind:submission="submission" v-bind:show-accepted="showAccepted" v-bind:key="submission.id" />
